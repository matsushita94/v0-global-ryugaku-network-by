...
export const contactHubContent: ContactHubContent = {
  ...
  title: "Contact Global Ryugaku Network",
  subtitle:
    "Choose the easiest way to reach us. We are available for student enquiries, school partnerships, and general business communication.",
  footerNote:
    "For the fastest response, contact us through WhatsApp, LINE, WeChat, phone, or email.",
